...
public class Informations extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        insta_texto = view.findViewById(R.id.insta_text);
        ...
        insta_texto.setOnClickListener(this);
...
//                sendWhatsApp.setPackage("com.whatsapp");
            ...
            case R.id.insta:
                ...
                sound_intent.setAction(Intent.ACTION_VIEW);
                sound_intent.addCategory(Intent.CATEGORY_BROWSABLE);
                sound_intent.setData(Uri.parse("https://www.instagram.com/radiofacom/"));
                startActivity(sound_intent);
                break;
            case R.id.insta_text:
                sound_intent = new Intent();
                sound_intent.setAction(Intent.ACTION_VIEW);
                sound_intent.addCategory(Intent.CATEGORY_BROWSABLE);
                sound_intent.setData(Uri.parse("https://www.instagram.com/radiofacom/"));
            ...
            case R.id.pet:
                ...
                pet_intent.setData(Uri.parse("http://www.peteletrica.com"));
