 ...
 */
@TargetApi(13)
public final class VideoList extends Fragment implements OnFullscreenListener, View.OnClickListener {
...
//    private View closeButton;
    ...
    private String url = "https://www.googleapis.com/youtube/v3/playlistItems";
    private String params = "?key="+Config.YOUTUBE_API_KEY+
            "&part=snippet,id"+
            "&maxResults=50"+
            "&playlistId=";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.videos_youtube, container, false);
    }
...
//        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        Log.d("Posicionamento", "onConfigurationChanged");
    ...
    public void onFullscreen(boolean isFullscreen) {
        ...
        Log.d("Posicionamento", "onFullscreen");
...
//        closeButton.setVisibility(isPortrait ? View.VISIBLE : View.GONE);
        ...
        if (isFullscreen) {
            Log.d("Posicionamento", "FullScreen");
//            videoBox.setTranslationY(0); // Reset any translation that was applied in portrait.
//            setLayoutSize(videoFragment.getView(), MATCH_PARENT, MATCH_PARENT);
//            setLayoutSizeAndGravity(videoBox, MATCH_PARENT, MATCH_PARENT, Gravity.TOP | Gravity.LEFT);
        } else if (isPortrait) {
            Log.d("Posicionamento", "Portrait");
            setLayoutSize(listFragment.getView(), MATCH_PARENT, MATCH_PARENT);
//            setLayoutSize(videoFragment.getView(), MATCH_PARENT, WRAP_CONTENT);
//            setLayoutSizeAndGravity(videoBox, MATCH_PARENT, WRAP_CONTENT, Gravity.BOTTOM);
        } else {
//            Log.d("Posicionamento", "Else");
//            videoBox.setTranslationY(0); // Reset any translation that was applied in portrait.
...
//    }
     ...
     */
    public static final class VideoListFragment extends ListFragment implements AsyncResponse {
...
//        @Override
//        public void retornaString (String url) {
//            urlFinal = url;
//        }
...
//            videoBox = getActivity().findViewById(R.id.video_box);
        ...
        public void onListItemClick(ListView l, View v, int position, long id) {
            ...
            Intent intent = new Intent(getActivity(), VideoFullscreen.class);
...
//            }
        ...
        public void getUrl(String urlFinal) {
            ...
            requestPlaylist.delegate = this;

            try {
                requestPlaylist.execute(urlFinal).get();
            } catch (Exception e) {

            }

            videoList = new ArrayList<VideoEntry>();
            String[] titulosArray = titulos.toArray(new String[titulos.size()]);
            String[] idArray = videosId.toArray(new String[videosId.size()]);
            for(int i = 0; i<titulosArray.length; i++) {
                videoList.add(new VideoEntry(titulosArray[i], idArray[i]));
            }
        ...
        static class RequestPlaylist extends AsyncTask {
            ...
            private void getInfo() {
                titulos = new ArrayList<>();
                id = new ArrayList<>();
                String[] titulosBruto = server_response.split("\"title\": \"");
                for(int i = 1; i<titulosBruto.length; i=i+2) {
                    titulos.add(titulosBruto[i].split("\",")[0]);
                }
                String[] idBruto = server_response.split("\"videoId\": \"");
                for(int i = 1; i<idBruto.length; i=i+2) {
                    id.add(idBruto[i].split("\"")[0]);
                }
                Log.i("Titulos", titulos.toString());
                Log.i("VideoIds", id.toString());
                delegate.processFinish(titulos, id);
            }
        }

        @Override
        public void processFinish(List<String> output1, List<String> output2) {
            titulos = output1;
            videosId = output2;
        }
